...
import com.github.lopoha.coboltruffle.parser.preprocessor.CobolPreprocessorBaseListener;
...
public class ParserPreprocessorListener extends CobolPreprocessorBaseListener {
    ...
    public void enterCopy(CobolPreprocessorParser.CopyContext ctx) {
        this.source.append(this.parserPreprocessor.getPreprocessedCopySource(ctx.ID().getText())).append(' ');
    }
