...
public abstract class CobolBiggerThanNode extends CobolBinaryNode {
  ...
  @Specialization
  @TruffleBoundary
  protected boolean biggerThan(CobolHeapPointer left, CobolHeapPointer right) {
    return left.compareTo(right) > 0;
  }

  @Specialization
  @TruffleBoundary
  protected boolean biggerThan(String left, CobolHeapPointer right) {
    return left.compareTo(right.getValue(null)) > 0;
  }

  @Specialization
  @TruffleBoundary
  protected boolean biggerThan(CobolHeapPointer left, String right) {
